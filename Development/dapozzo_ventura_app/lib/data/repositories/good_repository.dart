...
class GoodRepository {
  static Future<GoodModel> getGoodByColorAndTypology(ColorModel color,GoodTypologyModel typologyModel) async {
...
//FINIRE DI IMPLEMENTARE
   // var retVal = new List<GoodModel>();
    ...
    GoodModel retVal =
      GoodModel(type: typologyModel,images: ["image2.jpg"], color: color, size: "M", quantity: 10)
    ;
